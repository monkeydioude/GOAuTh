...
func (c *authClient) Delete(ctx context.Context, in *AuthIdRequest, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
...
func _Auth_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Delete(ctx, req.(*AuthIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
type JWTClient interface {
	Status(ctx context.Context, in *StatusIn, opts ...grpc.CallOption) (*StatusOut, error)
...
func (c *jWTClient) Status(ctx context.Context, in *StatusIn, opts ...grpc.CallOption) (*StatusOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusOut)
...
func (c *jWTClient) Refresh(ctx context.Context, in *RefreshIn, opts ...grpc.CallOption) (*RefreshOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RefreshOut)
...
type JWTServer interface {
	Status(context.Context, *StatusIn) (*StatusOut, error)
...
func (UnimplementedJWTServer) Status(context.Context, *StatusIn) (*StatusOut, error) {
	return nil, status.Error(codes.Unimplemented, "method Status not implemented")
}
func (UnimplementedJWTServer) Refresh(context.Context, *RefreshIn) (*RefreshOut, error) {
...
func RegisterJWTServer(s grpc.ServiceRegistrar, srv JWTServer) {
	// If the following call panics, it indicates UnimplementedJWTServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _JWT_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JWTServer).Status(ctx, req.(*StatusIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _JWT_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JWTServer).Refresh(ctx, req.(*RefreshIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (c *userActionClient) Create(ctx context.Context, in *UserActionRequest, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, UserAction_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userActionClient) Validate(ctx context.Context, in *UserActionValidation, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, UserAction_Validate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserActionServer) Create(context.Context, *UserActionRequest) (*Response, error) {
...
func RegisterUserActionServer(s grpc.ServiceRegistrar, srv UserActionServer) {
	// If the following call panics, it indicates UnimplementedUserActionServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _UserAction_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserActionServer).Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAction_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserActionServer).Create(ctx, req.(*UserActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserAction_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserActionValidation)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserActionServer).Validate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAction_Validate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserActionServer).Validate(ctx, req.(*UserActionValidation))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserAction_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.UserAction",
	HandlerType: (*UserActionServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Create",
			Handler:    _UserAction_Create_Handler,
		},
		{
			MethodName: "Validate",
