...
// HydrateEntity pass properties to the entity (such as a User, or DefaultUser)
// it is most likely used to pass a pointer to users related parameters to the entity.
func (l *Layout) HydrateEntity(e entities.Entity[entities.Parameters]) error {
	e.SetParameters(l.UserParams)
	return nil
}
