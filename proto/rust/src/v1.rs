...
pub mod auth_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn logout(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/v1.Auth/Logout");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("v1.Auth", "Logout"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod jwt_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn status(
            &mut self,
            request: impl tonic::IntoRequest<super::StatusIn>,
        ) -> std::result::Result<tonic::Response<super::StatusOut>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        pub async fn refresh(
            &mut self,
            request: impl tonic::IntoRequest<super::RefreshIn>,
        ) -> std::result::Result<tonic::Response<super::RefreshOut>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
...
pub mod user_action_client {
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct UserActionClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl UserActionClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> UserActionClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            UserActionClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn create(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/v1.UserAction/Create");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("v1.UserAction", "Create"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn validate(
            &mut self,
            request: impl tonic::IntoRequest<super::UserActionValidation>,
        ) -> std::result::Result<tonic::Response<super::Response>, tonic::Status> {
            self.inner
                .ready()
                .await
